...
function searchLanguage(e) {
  ...
  var t = [65, 90];
  return codefirstLetter >= 65 && codefirstLetter <= 90
    ? (t = [65, 90])
...
!(function () {
  "use strict";
  function e(e, t) {
    (this.wrapEl = e), this.wrapEl.classList.add("ws-area"), (this.solved = 0);
    var u = {
    ...
    if (
      ((this.settings = Object.merge(t, u)),
      this.parseWords(this.settings.gridSize))
    ) {
      for (var s = !1; 0 == s; ) this.initialize(), (s = this.addWords());
      this.settings.debug || this.fillUpFools(), this.drawmatrix();
    }
  }
  (Element.prototype.wordSearch = function (t) {
    ...
    (e.prototype.parseWords = function (e) {
      for (var t = !0, u = 0; u < this.settings.words.length; u++) {
        (this.settings.wordsList[u] = this.settings.words[u].trim()),
          (this.settings.words[u] = removeDiacritics(
            this.settings.wordsList[u].trim().toUpperCase()
          ));
        var s = this.settings.words[u];
        s.length > e &&
          (alert("The length of word `" + s + "` is overflow the gridSize."),
          console.error(
            "The length of word `" + s + "` is overflow the gridSize."
          ),
          (t = !1));
      }
      return t;
    ...
    (e.prototype.addWords = function () {
      for (var e = !0, t = 0, u = !0; e; ) {
        var s =
          ...
          r = this.addWord(this.settings.words[t], s),
          u = !0;
        0 == r && ((e = !1), (u = !1)),
          t++,
          t >= this.settings.words.length && (e = !1);
      }
      return u;
    }),
    (e.prototype.addWord = function (e, t) {
      var u,
        s,
        r = !0,
        i = { W: [0, 1], N: [1, 0], WN: [1, 1], EN: [1, -1] };
      switch (t) {
        case "W":
          var u = Math.rangeInt(this.settings.gridSize - 1),
            s = Math.rangeInt(this.settings.gridSize - e.length);
          break;
        case "N":
          var u = Math.rangeInt(this.settings.gridSize - e.length),
      ...
      for (var a = 0; a < e.length; a++) {
        var n = u + a * i[t][0],
          E = s + a * i[t][1],
          l = this.matrix[n][E].letter;
        "." == l || l == e[a] ? (this.matrix[n][E].letter = e[a]) : (r = !1);
      }
      return r;
    }),
    ...
    (e.prototype.initmatrix = function (e) {
      for (var t = 0; e > t; t++)
        for (var u = 0; e > u; u++) {
          ...
          this.matrix[t] || (this.matrix[t] = []), (this.matrix[t][u] = s);
        }
    }),
    (e.prototype.drawmatrix = function () {
      for (var e = 0; e < this.settings.gridSize; e++) {
        var t = document.createElement("div");
        t.setAttribute("class", "ws-row"), this.wrapEl.appendChild(t);
        for (var u = 0; u < this.settings.gridSize; u++) {
          ...
          (o.font = "400 28px Calibri"),
            ...
            s.addEventListener(
              "mousedown",
              this.onMousedown(this.matrix[e][u])
            ),
            s.addEventListener(
              "mouseover",
              this.onMouseover(this.matrix[e][u])
            ),
    ...
    (e.prototype.fillUpFools = function () {
      for (
        var e = searchLanguage(this.settings.words[0].split("")[0]), t = 0;
        t < this.settings.gridSize;
        t++
      )
        for (var u = 0; u < this.settings.gridSize; u++)
          "." == this.matrix[t][u].letter &&
            (this.matrix[t][u].letter = String.fromCharCode(
              Math.rangeInt(e[0], e[1])
            ));
    }),
    (e.prototype.getItems = function (e, t, u, s) {
      ...
      if (e === u || t === s || Math.abs(u - e) == Math.abs(s - t)) {
        ...
        do (a += i), (n += o), r.push(this.getItem(a, n));
        while (a !== u || n !== s);
      }
      return r;
    }),
    (e.prototype.getItem = function (e, t) {
      return this.matrix[e] ? this.matrix[e][t] : void 0;
    }),
    (e.prototype.clearHighlight = function () {
      for (
        var e = document.querySelectorAll(".ws-selected"), t = 0;
        t < e.length;
        t++
      )
    ...
    (e.prototype.lookup = function (e) {
      for (var t = [""], u = 0; u < e.length; u++) t[0] += e[u].letter;
      if (
        (t.push(t[0].split("").reverse().join("")),
        this.settings.words.indexOf(t[0]) > -1 ||
          this.settings.words.indexOf(t[1]) > -1)
      ) {
        for (var u = 0; u < e.length; u++) {
          ...
          i.classList.add("ws-found");
        }
        for (
          var o = document.querySelector(".ws-words"),
            a = o.getElementsByTagName("li"),
            u = 0;
          u < a.length;
          u++
        )
          t[0] == removeDiacritics(a[u].innerHTML.toUpperCase()) &&
            a[u].innerHTML != "<del>" + a[u].innerHTML + "</del>" &&
            ((a[u].innerHTML = "<del>" + a[u].innerHTML + "</del>"),
            this.solved++);
        this.solved == this.settings.words.length && this.gameOver();
      }
    }),
    (e.prototype.gameOver = function () {
      ...
      e.innerHTML =
        "<div class='ws-game-over-inner' id='ws-game-over-inner'><div class='ws-game-over' id='ws-game-over'><h2>Congratulations!</h2><p>You've found all of the words!</p></div></div>";
    }),
      ...
      return function () {
        if (t.selectFrom) {
          (t.selected = t.getItems(
            ...
            t.clearHighlight();
          for (var u = 0; u < t.selected.length; u++) {
            var s = t.selected[u],
              r = s.row + 1,
              i = s.col + 1,
